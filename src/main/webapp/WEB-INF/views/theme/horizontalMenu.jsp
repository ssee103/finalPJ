	...
	<div class="sidebar-menu">
		<div class="main-menu">
			<ul class="nav-menu">
				...
				<li class="submenu">
					<a href="#" >
						<i class="ti ti-smart-home"></i><span>Dashboarddddddddddddddddddddddddddddddddd</span>
						<span class="menu-arrow"></span>
					</a>
					<ul>
						<li><a href="index.html">Dashboarddddddddddddddddddddddddddddddddd Dashboard</a></li>
