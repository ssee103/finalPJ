					...
					<div class="col-md-8 d-flex justify-content-center align-items-center mx-auto">
						<div>
							<div class="error-images mb-4">
								<img src="${pageContext.request.contextPath }/assets/img/bg/error-404.svg" alt="image" class="img-fluid">
							</div>
							<div class="text-center">
								<h1 class="mb-3">404에러</h1>
								<p class="fs-16 text-center">페이지를 찾을 수 없습니다.<br>요청 경로를 다시 확인해 주십시오</p>
