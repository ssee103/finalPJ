		            ...
		            <div class="modal-body">
		                <form id="modalForm">
		                    <div id="departmentForm" style="display: none;">
		                        ...
		                        <input type="text" class="form-control form-control-sm" id="deptCodeDepartment" name="deptCode" required>
		                        <br>
		                        <label for="dprlr">부서장</label>
		                        <input type="text" class="form-control form-control-sm" id="dprlr" name="dprlr">
		                        <br>
		                        <label for="deptName">부서 이름</label>
		                        <input type="text" class="form-control form-control-sm" id="deptName" name="deptName" required>
		                    </div>
		                    
		                    <div id="teamForm" style="display: none;">
		                        <label for="teamCode">팀 코드</label>
		                        <input type="text" class="form-control form-control-sm" id="teamCode" name="teamCode" required>
		                        <br>
		                        <label for="deptCodeTeam">부서 코드</label>
		                        <input type="text" class="form-control form-control-sm" id="deptCodeTeam" name="deptCode" required>
		                        <br>
		                        <label for="teamHeader">팀장</label>
		                        <input type="text" class="form-control form-control-sm" id="teamHeader" name="teamHeader">
		                        <br>
		                        <label for="teamName">팀 이름</label>
		                        <input type="text" class="form-control form-control-sm" id="teamName" name="teamName" required>
		                    </div>
		                    
		                    <div id="delDepartmentForm" style="display: none;">
		                        <label for="delDepartmentCode">부서 코드</label>
		                        <input type="text" class="form-control form-control-sm" id="delDepartmentCode" name="deptCode" required>
		                    </div>
		                    
		                    <div id="delTeamForm" style="display: none;">
		                        <label for="delTeamCode">팀 코드</label>
		                        <input type="text" class="form-control form-control-sm" id="delTeamCode" name="teamCode" required>
		                    </div>
		                </form>
		            </div>
